  ...
  ***************************************/
  ...
  Datamap.prototype.updatePopup = function (element, d, options) {
    ...
    element.on('mousemove', function() {
      ...
      if ((urlsplit[urlsplit.length-1]=='edit') || (urlsplit[urlsplit.length-2]=='create'))
      {
      	var offsetTop = (position[1] + 30);
      	var offsetleft = (position[0]);
      }
      else
      {
      	var offsetTop = (e.clientY+window.pageYOffset+30);
